    ...
    <div className="flex flex-col h-screen bg-[#f8fafc] overflow-hidden">
      ...
      <main className="flex-grow p-6 sm:p-10 overflow-hidden flex flex-col max-w-7xl mx-auto w-full pb-32">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
          <div>
            <h1 className="text-4xl font-black tracking-tighter text-slate-900">Clientes</h1>
            <p className="text-slate-500 font-medium text-sm mt-1">Directorio y gestión de crédito</p>
          </div>
